...
import { VaccinationStoreService } from "./vaccination-store.service";
import { map } from "rxjs/operators";

export class VaccinationValidators {
  static keyFormat(control: FormControl): { [error: string]: any } {
    if (!control.value) {
      return null;
    }
  ...
  static keyExists(bs: VaccinationStoreService) {
    return function(
      control: FormControl
